...
#mean of all pixels in park for each day
empty_list[[j]]<-exact_extract(all, poly, 'mean') #intersects boundary

    }
  
out<-as.data.frame(empty_list)
out_median<-as.data.frame(rowMedians(as.matrix(out))) #median of mean day value
...
#save
write.csv(final_medians, "/Users/killion/final_medians2.csv", row.names = FALSE)
