...
L71 will need to be unhashed when working with our sample data - it selects only the months which have data in folder
...
# list_all<- list_all[c(1,4)] You will need to use this with our sample data folder
