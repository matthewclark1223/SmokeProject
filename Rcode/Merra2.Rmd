...
#fix - may not have to do this now
...
out_mean<-as.data.frame(rowMeans(out))
   
#write csv
  n<-substr(list_all[[i]][[j]],94,100) # !!!!!!!! you will have to change this based on the length of your filepaths
...
#save
write.csv(final_means, "/Users/killion/final_means.csv", row.names = FALSE)
