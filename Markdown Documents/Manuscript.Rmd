...
financialData%>%filter(UnitCode %in% fitsig$Par)%>%group_by(ParkName)%>%
  ...
  geom_rect( aes(xmin=100500000000, xmax=109500000000, ymin=-Inf, ymax=Inf), fill="grey") +
  ...
  annotate("text", x = 80000000000, y = "Yosemite NP", label = "Predicted fee revenue no smoke",vjust=-1,color="#b2df8a",fontface=2)+
