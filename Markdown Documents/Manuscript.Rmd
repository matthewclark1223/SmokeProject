...
ggplot(., 
  ...
  ggalt::geom_dumbbell(size = 1.2,
   ...
   annotate("text", x = 60000000, y = "Yosemite NP", label = "Observed visitation",vjust=-1,hjust=1)+
  annotate("text", x = 73000000, y = "Yosemite NP", label = "Predicted visitation no smoke",vjust=-1)+
