...
output:
  ...
  pdf_document:
    ...
    template: /Users/Matthewclark989/Documents/SmokeProject/svm_ms_template.tex
fontfamily: mathpazo
fontsize: 11pt
geometry: margin=1in
...
```{r echo=FALSE, cache=TRUE, warning=FALSE, message=FALSE, fig.height = 6, fig.width = 12}
