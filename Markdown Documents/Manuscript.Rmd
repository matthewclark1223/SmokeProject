...
ggplot(., 
  ...
  ggalt::geom_dumbbell(size = 1.2,
   ...
   annotate("text", x = 60000000, y = "Glacier NP", label = "Observed Visitation",vjust=-1,hjust=1)+
  annotate("text", x = 80000000, y = "Glacier NP", label = "Predicted Visitation No Smoke",vjust=-1)+
